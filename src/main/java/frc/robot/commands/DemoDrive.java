...
public class DemoDrive extends SequentialCommandGroup {
    ...
    public DemoDrive(Swerve swerve, Lift lift, WingPoseEstimator wingPoseEstimator, InputGetter inputGetter) {
        ...
        addCommands(
            ...
            new FollowPath(swerve, new Path(PathConstants.wayPoints, PathConstants.defaultSpeed, PathConstants.lookAhead, PathConstants.rotationalLookAhead), PathConstants.wayPoints.getLast()) // follow path to station
        );
    }
